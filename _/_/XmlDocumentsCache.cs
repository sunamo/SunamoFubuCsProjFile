...
public class XmlDocumentsCache
{
    ...
    public static Dictionary<string, XmlDocument> cache = new Dictionary<string, XmlDocument>();

    /// <summary>
    ///     In key is csproj path
    ///     In value is absolute path of references (recursive)
    /// </summary>
    public static Dictionary<string, List<string>> projectDeps = new Dictionary<string, List<string>>();
...
List<string>
    ...
    public static List<string> cantBeLoadWithDictToAvoidCollectionWasChangedButCanWithNull = new List<string>();
