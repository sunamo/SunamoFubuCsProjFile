namespace FubuCsprojFile.MSBuild
{
    public class MSBuildProject
    {
        ...
        public static string Schema => ConstsSE.Schema;
        ...
        {
            get => new Version(doc.DocumentElement.GetAttribute("ToolsVersion"));
            set
            {
                if (value != null)
        ...
        public static MSBuildProject Create(string assemblyName)
        {
            ...
            var st = /*Assembly.GetExecutingAssembly()*/ ass.GetManifestResourceStream(typeof(MSBuildProject), "FubuCsprojFile._NotMine.MSBuild.Project.txt");
...
await
 ...
 LoadFromAsync(string fileName)
        ...
        private class ProjectWriter : StringWriter
        {
            ...
            {
                encoding = bom != null ? Encoding.GetEncoding(FubuCsprojFile.MSBuild.ByteOrderMark.enum2String[bom.Name]) : null;
                ByteOrderMark = bom;
            }
